...
public class ModelAdapterEnderCrystal extends ModelAdapter
{
    ...
    public ModelRenderer getModelRenderer(ModelBase model, String modelPart)
    {
        ...
        else
        {
            ...
            return modelPart.equals("cube") ? new ModelRenderer(modelendercrystal) : (modelPart.equals("glass") ? new ModelRenderer(modelendercrystal) : (modelPart.equals("base") ? new ModelRenderer(modelendercrystal) : null));
        }
    }
