...
public class ModelAdapterSilverfish extends ModelAdapter
{
    ...
    public ModelRenderer getModelRenderer(ModelBase model, String modelPart)
    {
        ...
        else
        {
            ...
            {
                ModelRenderer[] amodelrenderer1 = new ModelRenderer[] {new ModelRenderer(modelsilverfish)};
            ...
            else
            {
                ...
                {
                    ModelRenderer[] amodelrenderer = new ModelRenderer[] {new ModelRenderer(modelsilverfish)};
