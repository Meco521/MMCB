...
public class ModelAdapterGuardian extends ModelAdapter
{
    ...
    public ModelRenderer getModelRenderer(ModelBase model, String modelPart)
    {
        ...
        else
        {
            ...
            {
                return new ModelRenderer(modelguardian);
            }
            ...
            else
            {
                ...
                {
                    ModelRenderer[] amodelrenderer1 = new ModelRenderer[] {new ModelRenderer(modelguardian)};
                ...
                else
                {
                    ...
                    {
                        ModelRenderer[] amodelrenderer = new ModelRenderer[] {new ModelRenderer(modelguardian)};
