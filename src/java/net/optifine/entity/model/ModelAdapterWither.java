...
public class ModelAdapterWither extends ModelAdapter
{
    ...
    public ModelRenderer getModelRenderer(ModelBase model, String modelPart)
    {
        ...
        else
        {
            ...
            {
                ModelRenderer[] amodelrenderer1 = new ModelRenderer[]{new ModelRenderer(modelwither)};
            ...
            else
            {
                ...
                {
                    ModelRenderer[] amodelrenderer = new ModelRenderer[]{new ModelRenderer(modelwither)};
