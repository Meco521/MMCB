...
public class SimpleReloadableResourceManager implements IReloadableResourceManager
{
    ...
    public void reloadResources(List<IResourcePack> resourcesPacksList, boolean language)
    {
        this.clearResources();
        ...
        this.notifyReloadListeners(language);
    }
    ...
    private void notifyReloadListeners(boolean language)
    {
        for (IResourceManagerReloadListener iresourcemanagerreloadlistener : this.reloadListeners) {
            if(language && !(iresourcemanagerreloadlistener instanceof LanguageManager))
                continue;
